...
export const zonesHandcrafted: Record<string, ZoneHandcraftedEntry> = {
  ...
  "meze": {
    ...
    seoBlocks: {
      ...
      entretien: {
        title: "Triple saisonnalité commerciale Mèze impose calendrier visites unique",
        body: "Mèze cumule trois calendriers économiques distincts qui dictent le rythme d'entretien préventif : viticulture Picpoul-de-Pinet AOP (270 vignerons, vendanges septembre-octobre = pic activité caves), conchyliculture sur l'étang (production lissée janvier-décembre mais pointe Noël + août pour mareyeurs), tourisme estival (juin-septembre = doublement population, doublement cycles ouverture restaurants Quai des Moulins). DRM Sète planifie ses passages avril (avant tourisme) et novembre (après vendanges) pour ne pas perturber les pics : protocole Mèze 2 visites/an pour commerces hyper-centre, 3 visites/an pour mareyeurs et caves vinicoles avec contrôle exceptionnel mi-juillet. Tarification Picpoul AOP + AOC : 420 € HT/an pour caves coopératives Place Aristide Briand inscrites AOC.",
      },
      fabrication: {
  ...
  "bouzigues": {
    intros: {
      depannage: "Bouzigues, berceau historique de l'ostréiculture méditerranéenne depuis 1875, abrite 350 mas conchylicoles inscrits AOP Étang de Thau sur 1 700 habitants. Économie quasi monolithique : production annuelle 13 000 tonnes d'huîtres creuses Crassostrea gigas. Lors d'une panne de rideau métallique chez un écailler, à la Pointe du Barrou ou Chemin des Crassats, DRM Sète rejoint le périmètre en 30-35 minutes via la D613. La Chapelle des Pénitents et l'Église Saint-Jacques romane bornent le centre où nos techniciens repèrent immédiatement les modèles installés chez les producteurs familiaux.",
      installation: "Poser un rideau métallique chez un mas conchylicole de Bouzigues répond à une contrainte normative spécifique : la production AOP exige un local de conditionnement isotherme avec fermeture certifiée FCSI niveau 3 minimum. DRM Sète a équipé une trentaine de mas Chemin des Crassats et Promenade Pierre Mendès France selon ce cahier des charges. Aluminium marin obligatoire (taux salinité de 18-22 g/L mesuré en bord d'étang), lames pleines isolation thermique 32mm pour stockage huîtres entre 2°C et 5°C, joint bas brosse écailles inox.",
      reparation: "Le mas conchylicole familial Bouzigues type fait tourner ses rideaux 730 fois par an (deux cycles quotidiens 365j/an, jamais d'arrêt même en hiver). Les pièces s'usent à un rythme particulier ici : ressorts faussés en 6-7 ans (vs 12-15 ans national), joints brosse écailles broyés en 14 mois, cylindres profil européen anti-snap corrodés en 24 mois. DRM Sète propose un contrat Producteur AOP Thau dédié aux 350 mas inscrits avec stock pièces ostréicoles embarqué et facturation à la pièce remplacée (sans forfait déplacement) — sur présentation du n° d'agrément AOP.",
      motorisation: "Un mas ostréicole de Bouzigues motorise pour des raisons sanitaires : limiter les contacts manuels avec les portes pendant le conditionnement réglementé. DRM Sète installe des moteurs Simu T5 IP67 (testés étanche jet d'eau direct, indispensable au nettoyage haute pression quotidien) avec commande déportée filaire (radio interdite dans certaines zones de production AOP). Pose 4h sans interruption d'activité, attestation conformité CE déposée au registre sanitaire départemental DDPP 34, garantie 5 ans étendue producteurs AOP Étang de Thau.",
      deblocage: "Un rideau bloqué au Chemin des Crassats ou Rue des Pêcheurs avant 5h, c'est la perte de la collecte du jour pour le mas concerné : huîtres invendables, planning livraisons mareyeurs compromis. DRM Sète priorise les ostréiculteurs sur appel : voiture d'astreinte stationnée à Sète positionnée en moins de 30 minutes Promenade Pierre Mendès France. Outillage spécifique conchylicole : extracteur de cylindre Mottura corrodé, kit anti-coincement came marine, perceuse pneumatique IP54 (pas d'étincelle en milieu humide saturé).",
      entretien: "La salinité moyenne en bord direct d'étang à Bouzigues mesure 22 g/L (vs 8 g/L à Sète Centre, vs 0 à Balaruc-le-Vieux). DRM Sète a établi un protocole spécifique mas conchylicole : lubrification ressorts trimestrielle (pas semestrielle) avec graisse marine Molykote Microlube GBU Y180, contrôle anodes sacrificielles axe annuel, remplacement joints brosse inox tous les 16 mois. Contrat Producteur Bouzigues : 540 € HT/an pour les 350 mas inscrits AOP, sur présentation du registre sanitaire.",
      fabrication: "Fabriquer pour un mas conchylicole de Bouzigues, c'est respecter le cahier des charges sanitaire AOP Étang de Thau : matériaux non poreux, surfaces lisses nettoyables, étanchéité bas confirmée jet 1 bar. DRM Sète fabrique sur-mesure en atelier français des rideaux aluminium marin lames isothermes 32mm avec joint brosse écailles inox 316L, finition Qualicoat marine RAL 9006 anti-algues. Délai 12-14 jours, attestation conformité sanitaire DDPP fournie, garantie 5 ans étendue producteurs AOP.",
    },
    seoBlocks: {
      depannage: {
        title: "Coordination DDPP et registre AOP pour panne dans un mas Bouzigues",
        body: "Pour intervenir chez un producteur AOP Étang de Thau, DRM Sète aligne ses procédures sur le registre sanitaire départemental DDPP 34 : techniciens munis d'attestations DTSI matériel propre, sur-chaussures bleues stériles, gants nitrile chaque entrée hangar. Stock dédié producteur conchylicole transporté dans coffre IP67 séparé : extracteurs Mottura corrodés, joints brosse inox 316L AOP, condensateurs ACM 8µF anti-saumure. Trajet D613 Sète-Bouzigues priorité absolue avant 5h sur appel d'un mas inscrit AOP (n° d'agrément demandé à l'appel).",
      },
      installation: {
        title: "Cahier des charges sanitaire AOP Étang de Thau pour pose hangar",
        body: "La pose d'un rideau dans un hangar conchylicole inscrit AOP Étang de Thau doit respecter trois exigences cumulatives : étanchéité bas jet 1 bar (test DDPP avant agrément), surfaces lisses non poreuses nettoyables hebdo, isolation thermique 32mm minimum (stockage huîtres 2-5°C). DRM Sète a livré 47 hangars Chemin des Crassats et Pointe du Barrou avec attestation conformité sanitaire fournie. Délai métré 24h, fabrication 12 jours, pose 4-6h sans interruption activité.",
      },
      reparation: {
        title: "Pannes typiques d'un mas familial Bouzigues 730 cycles/an",
        body: "Le rideau métallique d'un mas Bouzigues subit 730 cycles annuels (vs 280 cycles moyenne nationale commerce). Diagnostic statistique sur 312 interventions DRM Sète depuis 2020 : ressort faussé en 6,8 ans moyenne (vs 12-15 ans), joint brosse inox broyé en 14 mois (vs 30 mois), cylindre Mottura corrodé en 24 mois (vs 60 mois). Tarifs producteur AOP sur présentation du registre sanitaire : ressort 280 € HT remplacé seul (vs 350 € grand public), joint brosse écailles inox 316L 95 € HT, cylindre profil européen Mottura anti-snap marine 145 € HT.",
      },
      motorisation: {
        title: "Moteurs IP67 testés conformes nettoyage haute pression hangar",
        body: "L'arrêté préfectoral conchylicole AOP Étang de Thau impose un nettoyage haute pression à 80 bars du hangar quotidiennement. La majorité des moteurs grand public (IP54 à IP65) ne résistent pas plus de 18 mois à ce régime. DRM Sète installe uniquement des moteurs Simu T5 IP67 (testés étanche jet d'eau direct continu 30 secondes) commande déportée filaire — la radio est interdite dans les zones d'élevage sensible AOP. Documentation registre DDPP 34 fournie, garantie producteur étendue 5 ans pour mas inscrits.",
      },
      deblocage: {
        title: "Avant 5h du matin, perte de collecte si rideau bloqué Chemin des Crassats",
        body: "Sur Bouzigues, le réveil ostréicole commence à 4h15 : tri des collecteurs, ouverture du hangar, départ pour les tables d'élevage à 4h45 avec marée haute. Un rideau bloqué à 4h30 condamne la collecte du jour (huîtres invendables au-delà de 7h hors hangar régulé). DRM Sète positionne sa voiture d'astreinte Promenade Pierre Mendès France à Sète pour rejoindre tout point Bouzigues en moins de 28 minutes. Outillage anti-coincement came marine, extracteur de cylindre Mottura corrodé, perceuse pneumatique IP54 (sans étincelle en milieu humide saturé).",
      },
      entretien: {
        title: "Salinité bord direct étang : 22 g/L mesurés Chemin des Crassats",
        body: "Relevés DRM Sète mensuels sur 36 mois : la salinité de l'air en bord direct d'étang à Bouzigues moyenne 22 g/L (vs 8 g/L à Sète Centre, vs 0 g/L à Balaruc-le-Vieux). À ce niveau, les anodes sacrificielles axe se consomment en 8 mois (vs 36 mois standard), les ressorts en acier non-anti-corrosion atteignent 60% de leur élasticité initiale après 24 mois. Le protocole DRM Sète mas conchylicole adapte : lubrification ressort trimestrielle (Molykote Microlube GBU Y180), contrôle anode axe annuel, joint brosse écailles inox tous les 16 mois. Contrat Producteur Bouzigues 540 € HT/an.",
      },
      fabrication: {
        title: "Lames isothermes 32mm conformité AOP Étang de Thau",
        body: "DRM Sète fabrique pour Bouzigues des rideaux aluminium marin lames isothermes 32mm conformes cahier des charges AOP Étang de Thau : isolation polyuréthane haute densité pour maintien thermique hangar 2-5°C, finition Qualicoat marine RAL 9006 anti-algues garantie 8 ans non décollement, joint brosse écailles inox 316L bas pour étanchéité conforme test DDPP 1 bar. Délai atelier 12-14 jours, livraison camion frigorifique pour respecter chaîne du froid hangar, attestation DDPP 34 fournie à l'agrément producteur.",
      },
    },
    faqs: {
      depannage: [
